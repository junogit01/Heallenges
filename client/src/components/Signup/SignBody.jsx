          ...
          <form className="row " onSubmit={handleSubmit(submitEvent, errorEvent)}>
            ...
            <div className="col-sm-12 mb-3">
              <label htmlFor="nickname" className="form-label">
                닉네임 * : <span style={{ color: 'orange' }}>{errors.nickname?.message}</span>
              </label>
              <input
                type="text"
                className="form-control"
            ...
            <div className="col-sm-12 mb-3">
              ...
              <input type="text" className="form-control" id="about_me" {...register('about_me')} />
            </div>
            <div className="col-sm-12 mb-3">
              <label htmlFor="blog_url" className="form-label">
                SNS :{' '}
              </label>
              <input type="text" className="form-control" id="blog_url" {...register('blog_url')} />
            </div>
            ...
            <div className="col-sm-12 position-relative form-group">
              <button type="submit" className="btn btn-danger btn-lg" style={{ paddingTop: '10px' }}>
                회원가입
              </button>{' '}
              <button type="reset" className="btn btn-primary btn-lg" style={{ paddingTop: '10px' }}>
                다시하기
              </button>
            </div>
          </form>
