    ...
    <>
      <div className="card mb-4">
        <div className="mt-3">
          ...
          <button onClick={() => handleCategoryChange('notice')}>공지사항</button>
          <button onClick={() => handleCategoryChange('free')}>자유</button>
          <button onClick={() => handleCategoryChange('certification')}>인증</button>
